...
export class FlowiseController extends BaseChatbotController<FlowiseModel, FlowiseDto> {
  constructor(
    ...
    // this.botRepository = this.prismaRepository.flowise; // Removed as it's initialized in BaseChatbotController
    // this.settingsRepository = this.prismaRepository.flowiseSetting; // Removed as it's initialized in BaseChatbotController
